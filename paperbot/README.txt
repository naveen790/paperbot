This is a project done for Information Retreival. 
...
1) Copy all files from the paperbot folder.

2) Go inside the public_html folder and copy all the contents from paperbot to the public_html folder on your server.
